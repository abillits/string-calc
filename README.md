...
Imagine you are building a web application that allows users to enter mathematical terms in a text field.
 ...
 If you have any suggestions how to improve this library, feel free to discuss them in the [issue](https://github.com/abillits/string-calc/issues) section.
...
[Symbols/Concrete classes](src/abillits/StringCalc/Symbols/Concrete)
...
In case you need it, you may want to take a look at its [original implementation](https://github.com/abillits/string-calc/blob/ed7dda7ec9f36b35eec22d2af6c7fbac620bb382/src/abillits/StringCalc/Symbols/Concrete/Functions/IntDivFunction.php).
...
`\abillits\StringCalc\Exceptions\StringCalcException`.

* [Releases](https://github.com/abillits/string-calc/releases) of this library are 100% free of _known_ bugs.
...
look at the [implementation](src/abillits/StringCalc).
...
* Status of this repository: _Maintained_. Create an [issue](https://github.com/abillits/string-calc/issues)
